 ...
 */
class Student(name: String, surname: String, age: Int, private var studentId: String, private var academicYear: Short): Person(name, surname, age) {
    fun setStudentId(studentId: String) {
        this.studentId = studentId
    }

    fun setAcademicYear(academicYear: Short) {
    ...
    override fun toString(): String = super.toString() + ", studentId=${this.studentId}, academicYear=${this.academicYear}"
